...
The "TankTourney" software, including all original source code, UI layouts, and logic, is the exclusive intellectual property of the author. This is a proprietary project; it is NOT licensed under any open-source definition (OSI/FSF).

### 2. Grant of License
This source code is made public for transparency, educational purposes, and review only. No rights are granted to:
* Execute, run, or distribute the software for private or public use.
* Modify the software for redistribution.
* Use the software or its code for any commercial gain.
...
### 5. Termination
Unauthorized use of the software or breach of these terms immediately terminates all access and rights provided under this license.
